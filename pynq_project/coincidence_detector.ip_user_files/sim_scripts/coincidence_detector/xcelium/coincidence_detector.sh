...
#
# Script generated by Vivado on Wed May 15 09:25:54 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : coincidence_detector.sh
...
#
# Usage        : coincidence_detector.sh
#                coincidence_detector.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                coincidence_detector.sh [-reset_run]
#                coincidence_detector.sh [-reset_log]
#                coincidence_detector.sh [-help]
#
...
#                script (type 'coincidence_detector.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_15 -libname zynq_ultra_ps_e_vip_v1_0_15 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_2 -libname lib_pkg_v1_0_3 -libname axi_timer_v2_0_31 -libname generic_baseblocks_v2_1_1 -libname axi_register_slice_v2_1_29 -libname fifo_generator_v13_2_9 -libname axi_data_fifo_v2_1_28 -libname axi_crossbar_v2_1_30 -libname proc_sys_reset_v5_0_14 -libname axi_protocol_converter_v2_1_29 -libname axi_clock_converter_v2_1_28 -libname blk_mem_gen_v8_4_7 -libname axi_dwidth_converter_v2_1_29 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_15 zynq_ultra_ps_e_vip_v1_0_15 xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 lib_pkg_v1_0_3 axi_timer_v2_0_31 generic_baseblocks_v2_1_1 axi_register_slice_v2_1_29 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_crossbar_v2_1_30 proc_sys_reset_v5_0_14 axi_protocol_converter_v2_1_29 axi_clock_converter_v2_1_28 blk_mem_gen_v8_4_7 axi_dwidth_converter_v2_1_29)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "coincidence_detector.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./coincidence_detector.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work zynq_ultra_ps_e_vip_v1_0_15 $xmvlog_opts -sv +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/a63f/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_clock_converter_v2_1_28 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/769c/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/3c0c/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/ec67/hdl" +incdir+"../../../../coincidence_detector.gen/sources_1/bd/coincidence_detector/ipshared/2fcd/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.coincidence_detector xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.coincidence_detector -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log coincidence_detector_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./coincidence_detector.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: coincidence_detector.sh [-help]\n\
Usage: coincidence_detector.sh [-step]\n\
Usage: coincidence_detector.sh [-lib_map_path]\n\
Usage: coincidence_detector.sh [-reset_run]\n\
Usage: coincidence_detector.sh [-reset_log]\n\
Usage: coincidence_detector.sh [-keep_index]\n\
Usage: coincidence_detector.sh [-noclean_files]\n\n\
