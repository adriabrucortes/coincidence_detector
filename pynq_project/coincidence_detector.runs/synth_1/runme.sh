...
HD_PWD='C:/Users/HP/Documents/Projectes/Coincidence_detector/pynq_project/coincidence_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coincidence_detector_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coincidence_detector_wrapper.tcl
