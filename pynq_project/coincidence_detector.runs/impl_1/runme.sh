...
HD_PWD='C:/Users/HP/Documents/Projectes/Coincidence_detector/pynq_project/coincidence_detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log coincidence_detector_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source coincidence_detector_wrapper.tcl -notrace
